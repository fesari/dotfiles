# Generated by Powerlevel10k configuration wizard on 2025-05-08 at 13:25 AEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=0 # Was previously 254, changed to 0 (max)
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=0 # Was previously 250, changed to 0 (max)
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=0 # Was previously 255, changed to 0 (max)
