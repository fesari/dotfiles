...
plugins=(git zsh-autosuggestions zsh-interactive-cd colorize grc zsh-syntax-highlighting tmux)
...
fpath=(/Users/fesari/.docker/completions $fpath)
autoload -Uz compinit
compinit
# End of Docker CLI completions

# Force a beam cursor on startup to prevent tmux windows from using block cursors
echo -ne "\e[5 q"
